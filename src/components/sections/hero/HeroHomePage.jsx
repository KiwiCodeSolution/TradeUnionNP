  ...
  return (
    <section className="w-full overflow-hidden bg-bgGrey h-fit xl:h-[628px]">
      <Wrapper styles={"flex flex-col md:flex-row"}>
        ...
        <div className="order-1 md:order-2 w-full md:w-1/2 h-[514px] xl:h-full relative">
          <Image
            src={HeroImageFirst}
            width={586}
            height={628}
          ...
          <Image
            ...
            className="absolute top-10 xl:top-16 -right-16 animate-hero-slide-in"
          />
          <Image
            src={HeroImageThird}
            width={266}
            ...
            className="absolute bottom-6 -right-7 xl:bottom-14 xl:right-3"
          />
        </div>
      </Wrapper>
    </section>
