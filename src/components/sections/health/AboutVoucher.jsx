  ...
  return (
    <div className="w-full h-[420px] md:h-[650px] xl:h-[332px] relative py-5 px-6 md:pt-[60px] md:pl-[46px] md:pr-[38px] xl:pt-[85px] xl:pl-[6px]">
      ...
      >
        ...
        харчування протягом 7 днів. Профспілка сплачує 80% вартості путівки, а профспілчанину
        потрібно сплатити 20% від вартості путівки, проїзд в обидві сторони, особисті витрати.
      </p>
      <p
