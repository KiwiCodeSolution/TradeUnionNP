    ...
    <BaseSection>
      <Wrapper>
        ...
        <div className="w-full flex flex-col md:flex-row gap-y-4 md:gap-y-0">
          <div className="w-full md:w-2/5 flex flex-col gap-y-4 pt-6 md:pt-16 ">
        ...
        <div className="w-full bg-white rounded-t-lg border-b-4 border-red flex flex-col gap-y-4 md:gap-y-0 md:flex-row gap-x-8 p-6 md:p-12 relative">
          <div className="md:w-1/4 ">
            <Image
              ...
              height={235}
              alt="малюнок руки"
              className="hidden md:block absolute bottom-12 left-12 z-[2]"
            />
          </div>
          ...
          <p className="w-full md:w-2/4 text-lg text-grey text-center md:text-left">
