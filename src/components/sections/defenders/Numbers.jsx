...
const Numbers = () => {
  ...
  const numbersValues = [
    { id: 1, end: 10675612, start: 0, label: t("numbers.0") },
    { id: 2, end: 1154, start: 0, label: t("numbers.1") },
    { id: 3, end: 5, start: 0, label: t("numbers.2") },
    { id: 4, end: 2908853, start: 0, label: t("numbers.3") },
    { id: 5, end: 5742068, start: 0, label: t("numbers.4") },
  ];
